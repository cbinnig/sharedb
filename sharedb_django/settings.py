"""
Django settings for sharedb_django project.
...
SECRET_KEY = '+ztib4)971@w7p#ql&8wumlile8sfi7y#7-2p*w_gf##k$ev#w'
...
ROOT_URLCONF = 'sharedb_django.urls'
...
WSGI_APPLICATION = 'sharedb_django.wsgi.application'
